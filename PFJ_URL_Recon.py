"""
The following playbook allows for recon on any URL artifact. This includes parsing Proofpoint embedded URLs.
"""
...
def on_start(container):
    ...
    # call 'filter_10' block
    filter_10(container=container)
